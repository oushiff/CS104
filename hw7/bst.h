...
class BinarySearchTree 
{
	...
	public:
		...
		//Successor function - will return the next largest value after the current node 
...
bool BinarySearchTree<Key, Value>::iterator::operator!=(const BinarySearchTree<Key, Value>::iterator& rhs) const
{
	//returns an iterator by reference
	//get the keys, protected 
	// TODO
	return this->mCurrent != rhs.mCurrent;
	// return true;
	// return false; // A dummy return value until you provide your implementation.
...
typename BinarySearchTree<Key, Value>::iterator& BinarySearchTree<Key, Value>::iterator::operator=(const BinarySearchTree<Key, Value>::iterator& rhs)
{
	...
	//iterate through and copy
	 // A dummy return value until you provide your implementation.
}
...
typename BinarySearchTree<Key, Value>::iterator& BinarySearchTree<Key, Value>::iterator::operator++()
{
	...
	//successor find the node 

	//check if it has right hand child 
	...
	if(mCurrent->getRight()){
		...
		//first person who has left child

		while (mCurrent->getParent()){
			if(mCurrent->getParent()->getRight() == mCurrent) {
...
{
	// TODO
	Node<Key, Value>* mCurrent = internalFind(key);
